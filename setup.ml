...
(* OASIS_START *)
(* DO NOT EDIT (digest: d211cf5cb80ea6c657046792a7a0131b) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$probnetkat_interp", []))];
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples/probnetkat";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("frenetic", None)];
                      bs_build_tools =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("ocamlgraph",
                               Some (OASISVersion.VGreaterEqual "0.8.6"));
                   ...
                   {
                      lib_modules = ["Frenetic_ProbNetKAT_Interpreter"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "prob"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "Frenetic_ProbNetKAT_TE.ml"
                   });
               Executable
                 ({
                     cs_name = "probnetkat_interp";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "Frenetic_ProbNetKAT_Test.ml"
                   });
               Test
                 ({
                     cs_name = "probnetkat_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "probnetkat_interp"
                        ]
                   })
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\132\217\239v\208\173\158.d\243B\016\147KB\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
